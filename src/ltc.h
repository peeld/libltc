...
#ifdef LTC_EXPORTS
#define LTC_API __declspec(dllexport)
#else
#define LTC_API __declspec(dllimport)
#endif
 ...
 */
LTC_API void ltc_frame_to_time(SMPTETimecode* stime, LTCFrame* frame, int flags);
 ...
 */
LTC_API int ltc_frame_increment(LTCFrame* frame, int fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 */
LTC_API int ltc_frame_decrement(LTCFrame* frame, int fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 */
LTC_API LTCDecoder * ltc_decoder_create(int apv, int queue_size);
 ...
 */
LTC_API int ltc_decoder_free(LTCDecoder *d);
 ...
 */
LTC_API void ltc_decoder_write(LTCDecoder *d,
 ...
 */
LTC_API void ltc_decoder_write_double(LTCDecoder *d, double *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
LTC_API void ltc_decoder_write_float(LTCDecoder *d, float *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
LTC_API void ltc_decoder_write_s16(LTCDecoder *d, short *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
LTC_API void ltc_decoder_write_u16(LTCDecoder *d, unsigned short *buf, size_t size, ltc_off_t posinfo);
 ...
 */
LTC_API int ltc_decoder_read(LTCDecoder *d, LTCFrameExt *frame);

/**
 * Remove all LTC frames from the internal queue.
 * @param d decoder handle
 */
LTC_API void ltc_decoder_queue_flush(LTCDecoder* d);
 ...
 */
LTC_API int ltc_decoder_queue_length(LTCDecoder* d);
 ...
 */
LTC_API LTCEncoder* ltc_encoder_create(double sample_rate, double fps, enum LTC_TV_STANDARD standard, int flags);

/**
 * Release memory of the encoder.
 * @param e encoder handle
 */
LTC_API void ltc_encoder_free(LTCEncoder *e);
 ...
 */
LTC_API void ltc_encoder_set_timecode(LTCEncoder *e, SMPTETimecode *t);
 ...
 */
LTC_API void ltc_encoder_get_timecode(LTCEncoder *e, SMPTETimecode *t);
 ...
 */
LTC_API void ltc_encoder_set_user_bits(LTCEncoder *e, unsigned long data);
 ...
 */
LTC_API unsigned long ltc_frame_get_user_bits(LTCFrame *f);

/**
 * Move the encoder to the next timecode frame.
 * uses \ref ltc_frame_increment() internally.
 */
LTC_API int ltc_encoder_inc_timecode(LTCEncoder *e);
 ...
 */
LTC_API int ltc_encoder_dec_timecode(LTCEncoder *e);
 ...
 */
LTC_API void ltc_encoder_set_frame(LTCEncoder *e, LTCFrame *f);
 ...
 */
LTC_API void ltc_encoder_get_frame(LTCEncoder *e, LTCFrame *f);
 ...
 * pointed to by buf.
 */
LTC_API int ltc_encoder_copy_buffer(LTCEncoder *e, ltcsnd_sample_t *buf);
 ...
 */
LTC_API ltcsnd_sample_t *ltc_encoder_get_bufptr(LTCEncoder *e, int *size, int flush) DEPRECATED_EXPORT;
 ...
 */
LTC_API int ltc_encoder_get_bufferptr(LTCEncoder *e, ltcsnd_sample_t **buf, int flush);

/**
 * reset the write-pointer of the encoder-buffer
 * @param e encoder handle
 */
LTC_API void ltc_encoder_buffer_flush(LTCEncoder *e);
 ...
 */
LTC_API size_t ltc_encoder_get_buffersize(LTCEncoder *e);
 ...
 * @param flags binary combination of \ref LTC_BG_FLAGS
 */
LTC_API int ltc_encoder_reinit(LTCEncoder *e, double sample_rate, double fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 * @param e encoder handle
 */
LTC_API void ltc_encoder_reset(LTCEncoder *e);
 ...
 */
LTC_API int ltc_encoder_set_bufsize(LTCEncoder *e, double sample_rate, double fps) DEPRECATED_EXPORT;
 ...
 *   encoder unusable, call \ref ltc_encoder_free or realloc the buffer)
 */
LTC_API int ltc_encoder_set_buffersize(LTCEncoder *e, double sample_rate, double fps);
 ...
 */
LTC_API double ltc_encoder_get_volume(LTCEncoder *e);
 ...
 */
LTC_API int ltc_encoder_set_volume(LTCEncoder *e, double dBFS);
 ...
 */
LTC_API double ltc_encoder_get_filter(LTCEncoder *e);
 ...
 */
LTC_API void ltc_encoder_set_filter(LTCEncoder *e, double rise_time);
 ...
 */
LTC_API int ltc_encoder_encode_byte(LTCEncoder *e, int byte, double speed);
 ...
 * @return 0 on success, -1 if byte is invalid or buffer overflow (speed > 10.0)
 */
LTC_API int ltc_encoder_end_encode(LTCEncoder *e);
 ...
 * @param e encoder handle
 */
LTC_API void ltc_encoder_encode_frame(LTCEncoder *e);
 ...
 * @param e encoder handle
 */
LTC_API void ltc_encoder_encode_reversed_frame(LTCEncoder *e);
 ...
 */
LTC_API void ltc_frame_set_parity(LTCFrame *frame, enum LTC_TV_STANDARD standard);
 ...
 */
LTC_API int ltc_frame_parse_bcg_flags(LTCFrame *frame, enum LTC_TV_STANDARD standard);
 ...
 */
LTC_API ltc_off_t ltc_frame_alignment(double samples_per_frame, enum LTC_TV_STANDARD standard);
